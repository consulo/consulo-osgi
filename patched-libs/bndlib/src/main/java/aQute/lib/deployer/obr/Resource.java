...
public class Resource {
  ...
  public Require findRequire(String name) {
    for (Require require : requires) {
      if (name.equals(require.getName())) return require;
    }
    return null;
  }
  ...
  public Require findPackageRequire(String usesPkgName) {
    ...
    for (Require require : requires) {
      if (CapabilityType.PACKAGE.getTypeName().equals(require.getName())) {
        ...
        if (filter.indexOf(matchString) > -1) return require;
      }
    }
    return null;
  }
  ...
  public String toString() {
    ...
    builder.append("Resource [id=").append(id).append(", presentationName=").append(presentationName).append(", symbolicName=")
      .append(symbolicName).append(", baseUrl=").append(baseUrl).append(", url=").append(url).append(", version=").append(version)
  ...
  public boolean equals(Object obj) {
    ...
    if (presentationName == null) {
      if (other.presentationName != null) return false;
    }
    else if (!presentationName.equals(other.presentationName)) return false;
