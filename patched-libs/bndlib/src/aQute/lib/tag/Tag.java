...
public class Tag {
  ...
  public Tag addAttribute(String key, Date value) {
    if (value != null) attributes.put(key, format.format(value));
    return this;
  }
  ...
  public Tag addContent(String string) {
    if (string != null) content.add(string);
    return this;
  }
  ...
  public List<Object> getContents(String tag) {
    ...
    for (Object o : out) {
      if (o instanceof Tag && ((Tag)o).getName().equals(tag)) out.add(o);
    }
    return out;
  }
  ...
  void select(String path, List<Tag> results, Tag mapping) {
    ...
    for (Object o : content) {
      if (o instanceof Tag) {
        Tag child = (Tag)o;
        if (child.getName().equals(elementName) || elementName.equals("*")) child.select(remainder, results, mapping);
      }
    }
  }
  ...
  public String getStringContent() {
    StringBuffer sb = new StringBuffer();
    for (Object c : content) {
      if (!(c instanceof Tag)) sb.append(c);
    }
    return sb.toString();
  }
