...
public class OBR extends AbstractBaseOBR {
  ...
  public void setProperties(Map<String, String> map) {
    ...
    if (cacheDirStr != null) cacheDir = new File(cacheDirStr);
  }
  ...
  private FileRepo lookupCachedFileRepo() {
    if (registry != null) {
      ...
      for (FileRepo repo : repos) {
        if ("cache".equals(repo.getName())) return repo;
      }
    }
    return null;
  }
  ...
  public String getName() {
    if (name != null && name != this.getClass().getName()) return name;
