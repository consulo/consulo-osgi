...
public class CachingURLResourceHandle implements ResourceHandle {
  ...
  public CachingURLResourceHandle(String url, String baseUrl, final File cacheDir, URLConnector connector, CachingMode mode)
    throws IOException {
        ...
        try {
          ...
          if (cachedFile.exists()) {
            ...
            throw new IOException(
              String.format("Download of remote resource %s failed and cached file %s not available!", url, cachedFile));
          }
        }
      default:
