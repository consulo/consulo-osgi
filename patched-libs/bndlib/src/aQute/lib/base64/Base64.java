...
public class Base64 {
  ...
  public final static byte[] decodeBase64(String string) {
    ...
    while (i < string.length()) {
      ...
      if (c > 0x7F) throw new IllegalArgumentException("Invalid base64 character in " + string + ", character value > 128 ");
      ...
      if (c == '=') {
        ...
        v = values[c];
        if (v < 0) throw new IllegalArgumentException("Invalid base64 character in " + string + ", " + c);
      }
      register <<= 6;
      register |= v;
