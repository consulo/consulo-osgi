...
public class Version implements Comparable<Version> {
  ...
  public Version(String version) {
    ...
    if (!m.matches()) throw new IllegalArgumentException("Invalid syntax for version: " + version);
  ...
  public int compareTo(Version other) {
    ...
    int c = 0;
    if (qualifier != null) c = 1;
    if (o.qualifier != null) c += 2;
  ...
  public boolean equals(Object ot) {
    if (!(ot instanceof Version)) return false;
