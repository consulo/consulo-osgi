...
public class Syntax implements Constants {
  ...
  static Syntax version =
    new Syntax(VERSION_ATTRIBUTE, "A version range to select the version of an export definition. The default value is 0.0.0 .",
               "version=\"[1.2,3.0)\"", null, Verifier.VERSIONRANGE);
  static Syntax bundle_symbolic_name = new Syntax(BUNDLE_SYMBOLIC_NAME_ATTRIBUTE, "The bundle symbolic name of the exporting bundle.",
                                                  "bundle-symbolic-name=com.acme.foo.daffy", null, Verifier.SYMBOLICNAME);
  ...
  static Syntax bundle_version = new Syntax(BUNDLE_VERSION_ATTRIBUTE,
                                            ...
                                            "bundle-version=1.3", null, Verifier.VERSIONRANGE);

  static Syntax path_version =
    new Syntax(VERSION_ATTRIBUTE, "Specifies the range in the repository, project, or file", "version=project", "project,type",
               Pattern.compile("project|type|" + Verifier.VERSIONRANGE.toString()));

  @SuppressWarnings("deprecation")
  static Syntax[] syntaxes = new Syntax[]{
    new Syntax(BUNDLE_ACTIVATIONPOLICY, "The Bundle-ActivationPolicy specifies how the framework should activate the bundle once started. ",
               "Bundle-ActivationPolicy: lazy", "lazy", Pattern.compile("lazy")),

    new Syntax(BUNDLE_ACTIVATOR, "The Bundle-Activator header specifies the name of the class used to start and stop the bundle. ",
               "Bundle-Activator: com.acme.foo.Activator", "${classes;implementing;org.osgi.framework.BundleActivator}",
               Verifier.FQNPATTERN),
    new Syntax(BUNDLE_CATEGORY, "The Bundle-Category header holds a comma-separated list of category names", "Bundle-Category: test",
               "osgi,test,game,util,eclipse,netbeans,jdk,specification", null), new Syntax(BUNDLE_CLASSPATH,
    ...
    new Syntax(BUNDLE_CONTACTADDRESS, "The Bundle-ContactAddress header provides the contact address of the vendor. ",
               "Bundle-ContactAddress: 2400 Oswego Road, Austin, TX 74563", null, null),
    new Syntax(BUNDLE_COPYRIGHT, "The Bundle-Copyright header contains the copyright specification for this bundle. ",
    ...
    new Syntax(BUNDLE_DOCURL, "The Bundle-DocURL headers must contain a URL pointing to documentation about this bundle.",
    ...
    new Syntax(BUNDLE_ICON,
               ...
               "Bundle-Icon: /icons/bnd.png;size=64", "/icons/bundle.png", Verifier.URLPATTERN,
               new Syntax("size", "Icons size in pixels, e.g. 64", "64", "16,32,48,64,128", Verifier.NUMBERPATTERN)),

    new Syntax(BUNDLE_LICENSE,
               ...
               "Bundle License: http://www.opensource.org/licenses/jabberpl.php", "http://www.apache.org/licenses/LICENSE-2.0,<<EXTERNAL>>",
               Pattern.compile("(" + Verifier.URLPATTERN + "|<<EXTERNAL>>)"),
               new Syntax(DESCRIPTION_ATTRIBUTE, "Human readable description of the license", "description=\"Described the license here\"",
                          null, Verifier.ANYPATTERN), new Syntax(LINK_ATTRIBUTE, "", "", null, Verifier.URLPATTERN)),
    new Syntax(BUNDLE_LOCALIZATION,
               ...
               "Bundle-Localization: OSGI-INF/l10n/bundle", "OSGI-INF/l10n/bundle", Verifier.URLPATTERN), new Syntax(BUNDLE_MANIFESTVERSION,
    ...
    new Syntax(BUNDLE_NAME,
               ...
               "Bundle-Name: My Bundle", null, Verifier.ANYPATTERN), new Syntax(BUNDLE_NATIVECODE,
                                                                                ...
                                                                                null, Verifier.PATHPATTERN, new Syntax(OSNAME_ATTRIBUTE,
                                                                                ...
                                                                                new Syntax(PROCESSOR_ATTRIBUTE, "Processor name",
                                                                                           "processor=x86",
                                                                                           Processor.join(Verifier.PROCESSORNAMES, ","),
                                                                                           Verifier.ANYPATTERN),
    ...
    new Syntax(BUNDLE_REQUIREDEXECUTIONENVIRONMENT,
               ...
               "Bundle-RequiredExecutionEnvironment: CDC-1.0/Foundation-1.0", Processor.join(Verifier.EES, ","), Verifier.ANYPATTERN),

    new Syntax(BUNDLE_SYMBOLICNAME,
               ...
               "Bundle-SymbolicName: com.acme.foo.daffy;singleton:=true", "${p}", Verifier.SYMBOLICNAME, new Syntax(SINGLETON_DIRECTIVE,
    ...
    new Syntax(BUNDLE_UPDATELOCATION,
    ...
    new Syntax(BUNDLE_VENDOR, "The Bundle-Vendor header contains a human-readable description of the bundle vendor. ",
               "Bundle-Vendor: OSGi Alliance ", null, null),

    new Syntax(BUNDLE_VERSION, "The Bundle-Version header specifies the version of this bundle", "Bundle-Version: 1.23.4.build200903221000",
               null, Verifier.VERSION),

    new Syntax(DYNAMICIMPORT_PACKAGE,
               ...
               "DynamicImport-Package: com.acme.plugin.*", "", Verifier.WILDCARDNAMEPATTERN, version, bundle_symbolic_name, bundle_version),

    new Syntax(EXPORT_PACKAGE, "The Export-Package header contains a declaration of exported packages.",
               "Export-Package: org.osgi.util.tracker;version=1.3", "${packages}", null, new Syntax(NO_IMPORT_DIRECTIVE,
               ...
               new Syntax(USES_DIRECTIVE,
                          ...
                          "Is calculated by bnd", null, null), new Syntax(MANDATORY_DIRECTIVE,
               ...
               new Syntax(EXCLUDE_DIRECTIVE, "A comma-separated list of class names that must not be visible to an importer",
                          "exclude:=\"QuxImpl*,BarImpl\"", null, Verifier.WILDCARDNAMEPATTERN),
               new Syntax(IMPORT_DIRECTIVE, "Experimental", "", null, null)

    ), new Syntax(EXPORT_SERVICE, "Deprecated", "Export-Service: org.osgi.service.log.LogService ", "${classes;implementing;*}", null),
    new Syntax(FRAGMENT_HOST, "The Fragment-Host header defines the host bundle for this fragment.",
               "Fragment-Host: org.eclipse.swt; bundle-version=\"[3.0.0,4.0.0)\"", null, null, new Syntax(EXTENSION_DIRECTIVE,
                                                                                                          ...
                                                                                                          "extension:=framework",
                                                                                                          "framework,bootclasspath", Pattern
      .compile("framework|bootclasspath")), bundle_version), new Syntax(IMPORT_PACKAGE,
                                                                        ...
                                                                        "${exported_packages}", Verifier.WILDCARDNAMEPATTERN,
    ...
    new Syntax(REQUIRE_BUNDLE, "The Require-Bundle header specifies the required exports from another bundle.",
               "Require-Bundle: com.acme.chess", null, Verifier.WILDCARDNAMEPATTERN,
               ...
               new Syntax(SPLIT_PACKAGE_DIRECTIVE,
                          ...
                          "-split-package:=merge-first", "merge-first,merge-last,error,first",
                          Pattern.compile("merge-first|merge-last|error|first")), bundle_version

    ), new Syntax(BUILDPATH, "Provides the class path for building the jar. The entries are references to the repository",
                  "-buildpath=osgi;version=4.1", "${repo;bsns}", Verifier.SYMBOLICNAME, path_version),
    new Syntax(BUMPPOLICY, "Sets the version bump policy. This is a parameter to the ${version} macro.", "-bumppolicy==+0", "==+,=+0,+00",
               Pattern.compile("[=+-0][=+-0][=+-0]")),

    new Syntax(CONDUIT, "Allows a bnd file to point to files which will be returned when the bnd file is build", "-conduit= jar/osgi.jar",
               null, null),
    ...
    new Syntax(DEPLOYREPO, "Specifies to which repo the project should be deployed.", "-deployrepo=cnf", "${repos}", null),

    new Syntax(DONOTCOPY, "Regular expression for names of files and directories that should not be copied when discovered",
    ...
    new Syntax(FAIL_OK, "Return with an ok status (0) even if the build generates errors", "-failok=true", "true,false",
               Verifier.TRUEORFALSEPATTERN),
    ...
    new Syntax(MAKE,
               ...
               new Syntax("recipe", "Recipe for the plugin, can use back references", "recipe=\"bnd/$1.bnd\"", "bnd", null)),

    new Syntax(MANIFEST, "Directly include a manifest, do not use the calculated manifest", "-manifest = META-INF/MANIFEST.MF", null, null),

    new Syntax(NOEXTRAHEADERS, "Do not generate housekeeping headers", "-noextraheaders", "true,false", Verifier.TRUEORFALSEPATTERN),
    ...
    new Syntax(PEDANTIC, "Warn about things that are not really wrong but still not right", "-nope=true", "true,false",
               Verifier.TRUEORFALSEPATTERN),

    new Syntax(PLUGIN, "Define the plugins", "-plugin=aQute.lib.spring.SpringComponent,aQute.lib.deployer.FileRepo;location=${repo}", null,
               null),

    new Syntax(SERVICE_COMPONENT, "The header for Declarative Services", "Service-Component=com.acme.Foo?;activate='start'", null, null),

    new Syntax(POM, "Generate a maven pom", "-pom=true", "true,false", Verifier.TRUEORFALSEPATTERN),

    new Syntax(RELEASEREPO, "Specifies to which repo the project should be released.", "-releaserepo=cnf", "${repos}", null),

    new Syntax(REMOVEHEADERS, "Remove all headers that match the regular expressions", "-removeheaders=FOO_.*,Proprietary", null, null),
    new Syntax(RESOURCEONLY, "Normally bnd warns when the JAR does not contain any classes, this option suppresses this warning",
               "-resourceonly=true", "true,false", Verifier.TRUEORFALSEPATTERN),
    new Syntax(SOURCES, "Include sources in the jar", "-sources=true", "true,false", Verifier.TRUEORFALSEPATTERN),
    new Syntax(SOURCEPATH, "List of directory names that used to source sources for -sources", "-sourcepath:= src, test", null, null),
    new Syntax(SUB, "Build a set of bnd files that use this bnd file as a basis. The list of bnd file can be specified with wildcards",
    ...
    new Syntax(RUNSYSTEMPACKAGES, "Add additional system packages to a framework run", "-runsystempackages=com.acme.foo,javax.management",
               null, null), new Syntax(RUNBUNDLES,
    ...
    new Syntax(RUNPATH, "Additional JARs for the VM path, should include the framework", "-runpath=org.eclipse.osgi;version=3.5", null,
               null, path_version), new Syntax(RUNVM,
