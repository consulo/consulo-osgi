...
public interface RepositoryPlugin {
   ...
   * @param range Version range for this bundle,"latest" if you only want the
   ...
   * @param range    Version range for this bundle,"latest" if you only want the
   *                 latest, or null when you want all.
   * @param strategy Get the highest or the lowest
   * @return A list of URLs sorted on version, lowest version is at index 0.
   *         null is returned when no files with the given bsn ould be found.
   * @throws Exception when anything goes wrong
   */
   ...
   *
   * @param regex if not null, match against the bsn and if matches, return
   *              otherwise skip
